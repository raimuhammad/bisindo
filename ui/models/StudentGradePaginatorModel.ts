...
export type StudentGradePaginatorModelType = Instance<
  typeof StudentGradePaginatorModel.Type
>;

/* A graphql query fragment builders for StudentGradePaginatorModel */
export {
  selectFromStudentGradePaginator,
  studentGradePaginatorModelPrimitives,
  StudentGradePaginatorModelSelector,
} from "./StudentGradePaginatorModel.base";
 ...
 */
export const StudentGradePaginatorModel =
  StudentGradePaginatorModelBase.actions((self) => ({
