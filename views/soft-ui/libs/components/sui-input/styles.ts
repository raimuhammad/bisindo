...
export const useClasses = makeStyles(
  ({ palette, boxShadows, functions, typography, borders }: any) => {
    ...
    return {
      suiInput: {
        backgroundColor: ({ disabled }: any) => (disabled ? grey[200] : white.main),
      },
      ...
      suiInput_focused: {
        ...
        // paddingLeft: ({ direction, withIcon }: any) => {
        ...
        // },
        // paddingRight: ({ direction, withIcon }: any) => {
      ...
      suiInputIcon_input: {
        ...
        borderRadius: ({ direction, withIcon }: any) => {
      ...
      suiInputIcon_icon: {
        ...
        fontSize: ({ size }: any) => size === "small" && `${fontSize.regular} !important`,
      },
    };
  }
);
